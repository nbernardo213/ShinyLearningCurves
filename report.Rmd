...
**`r as.character(params$SetTbl[1,params$n])`**: y = `r round(coef(nls(y1~a*x^b,data = params$DF2,start = list(a=1,b=1)))[1],4)` x ^(`r round(coef(nls(y1~a*x^b,data = params$DF2,start = list(a=1,b=1)))[2],4)`) (Red)

**`r as.character(params$SetTbl[2,params$n])`**: y = `r round(coef(nls(y2~a*x^b,data = params$DF2,start = list(a=1,b=1)))[1],4)` x ^(`r round(coef(nls(y2~a*x^b,data = params$DF2,start = list(a=1,b=1)))[2],4)`) (Green)

**`r as.character(params$SetTbl[3,params$n])`**: y = `r round(coef(nls(y3~a*x^b,data = params$DF2,start = list(a=1,b=1)))[1],4)` x ^(`r round(coef(nls(y3~a*x^b,data = params$DF2,start = list(a=1,b=1)))[2],4)`) (Blue)
